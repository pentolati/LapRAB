...
SRC = HERE / "00-START-HERE.md"
OUT = HERE / "00-START-HERE.pdf"
...
@page {
    ...
    margin: 1.8cm 1.6cm;
    @bottom-center {
        content: "Peta Tata-Eleven · " counter(page) " / " counter(pages);
...
<html><head><meta charset="utf-8"><title>Peta Tata-Eleven</title></head>
