...
SRC = HERE / "03-HANDBOOK.md"
OUT = HERE / "03-handbook.pdf"
...
@page {
    ...
    margin: 1.8cm 1.6cm;
    @bottom-center {
        content: "Tata-Eleven Handbook · " counter(page) " / " counter(pages);
...
<html><head><meta charset="utf-8"><title>Tata-Eleven Handbook</title></head>
